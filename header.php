...
<body <?php body_class(get_field('add_class_body', get_the_ID())); ?> data-lenis-options='{"duration": 1.5, "smoothWheel": true}' data-lenis-restore-scroll="true">
    <?php wp_body_open(); ?>
    <?php if (stripos($_SERVER['HTTP_USER_AGENT'], 'Chrome-Lighthouse') === false) : ?>
        ...
        <div class="section-header">
            <div class="wrap-left-header">
                <div class="header-logo img img-ratio ratio:pt-[80_241]">
                    <a href="<?php echo esc_url(home_url('/')); ?>">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/header-logo.svg" alt="<?php bloginfo('name'); ?>" />
                    </a>
                </div>
            </div>
            <div class="wrap-right-header">
                ...
                <div class="block-btn-header">
                    <a class="btn btn-primary" href="<?php echo esc_url(wp_login_url()); ?>"><span>Đăng ký / Đăng nhập</span></a>
