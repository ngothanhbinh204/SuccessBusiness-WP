    				...
    				<div class="box-logo">
    					<div class="img img-ratio ratio:pt-[80_241]">
    						...
    						<a href="<?php echo esc_url(home_url('/')); ?>">
    							<img class="lozad" data-src="<?php echo esc_url($footer_logo); ?>"
    				...
    				<div class="box-social">
    					...
    					<ul>
    						...
    						<li><a href="<?php echo esc_url($link); ?>"><i
    									class="fa-brands <?php echo esc_attr($icon_class); ?>"></i></a></li>
    						<?php endwhile; ?>
    					</ul>
    					<?php endif; ?>
    				</div>
    			...
    			<div class="block-footer-bottom">
    				<div class="box-info-footer">
    					...
    					<div class="item-footer-right">
    						...
    						<div class="sub-item-footer-bottom"
    							data-stick-options='{"stickBelow": 1199,"position": "both","gutter": 0}'>
    							...
    							<div class="footer-copy-btn">
    								...
    								<div class="footer-copyright">
    									<h3 class="title-copyright body-3">
    										<?php $footer_copy_right = get_field('copy_right_footer', 'option'); ?>
    										<?php if ($footer_copy_right) { echo wp_kses_post($footer_copy_right); } ?>
    ...
    <div class="header-search-form">
    	...
    	<div class="container">
    		<form role="search" method="get" class="wrap-form-search-product"
    			action="<?php echo esc_url(home_url('/')); ?>">
    			<div class="productsearchbox">
    				<input type="text" name="s" placeholder="<?php _e('Tìm kiếm...', 'canhcamtheme'); ?>">
    				<button type="submit" class="btn-search">
    					<?php _e('Tìm kiếm', 'canhcamtheme'); ?>
    				</button>
    			</div>
    			<div class="message-search"><?php _e('Nhấn', 'canhcamtheme'); ?><span> Esc</span>
    				<?php _e('để đóng', 'canhcamtheme'); ?></div>
    		</form>
    	</div>
    </div>
    ...
    <div class="navbar-mobile p-0">
    	<div class="mobi-bg w-full md:w-1/2 xl:w-[450px] !max-w-full h-full bg-white z-50 p-5 relative">
    		<form role="search" method="get" class="header-search-form-mobile productsearchbox"
    			action="<?php echo esc_url(home_url('/')); ?>">
    			<input type="text" name="s" placeholder="<?php _e('Tìm kiếm...', 'canhcamtheme'); ?>">
    			<button type="submit" class="btn-search"><?php _e('Tìm kiếm', 'canhcamtheme'); ?></button>
    		</form>
    		<div class="menu-list">
    			<?php 
                wp_nav_menu(array(
    ...
    <div class="tool-fixed-cta">
    	...
    	<?php if ($cta_phone): ?>
    	<div class="btn btn-content btn-phone">
    		<div class="btn-icon">
    			<div class="icon"><i class="fa-light fa-phone"></i></div>
    		</div>
    		<div class="content"><?php echo wp_kses_post($cta_phone); ?></div>
    	</div>
    	<?php endif; ?>
